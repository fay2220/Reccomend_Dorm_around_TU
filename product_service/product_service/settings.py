...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'product_service', 'media')
...
DATABASES = {
    'default': {
        ...
        'USER': os.getenv('POSTGRES_USER', 'cn334Admin'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'cn334Admin'),
...
MEDIA_ROOT = BASE_DIR / "media"        # …/product_service/media
MEDIA_URL  = "/media/"  
